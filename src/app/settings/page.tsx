    ...
    <div className="p-4 md:p-6 max-w-3xl">
      ...
      <div className="grid gap-6">
        ...
        <TagEditor
          ...
          onAdd={() =>
            addItem("interests", newInterest, profile, setProfile, setNewInterest)
          }
        ...
        <TagEditor
          ...
          onAdd={() =>
            addItem("languages", newLanguage, profile, setProfile, setNewLanguage)
          }
